'use client'
import ContactForm from '~/components/visual-editor/forms/contact-form'
import { Badge } from '~/components/visual-editor/ui/badge'
import { toast } from '~/components/visual-editor/ui/use-toast'
import { EditorBtns } from '~/lib/visual-editor/constants'
import {
  getFunnel,
...
import { ContactUserFormSchema } from '~/lib/visual-editor/types'
import { EditorElement, useEditor } from '~/providers/visual-editor/editor/editor-provider'
      ...
      <ContactForm
        subTitle={
          !Array.isArray(props.element.content)
            ? props.element.content.subTitle || 'Contact Us'
            : 'Contact Us'
        }
        title={
          !Array.isArray(props.element.content)
            ? props.element.content.title ||
              'Want a free quote? We can help you'
            : 'Want a free quote? We can help you'
        }
        apiCall={state.editor.liveMode ? onFormSubmit : undefined}
        styles={styles}
      />
      {state.editor.selectedElement.id === props.element.id &&
        !state.editor.liveMode && (

...
import TagComponent from '~/components/visual-editor/global/tag'
...
import { Avatar, AvatarFallback, AvatarImage } from '~/components/visual-editor/ui/avatar'
import {
  Card,
  CardDescription,
  CardFooter,
...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from '~/components/visual-editor/ui/hover-card'
import { toast } from '~/components/visual-editor/ui/use-toast'
import { deleteTicket, saveActivityLogsNotification } from '~/lib/visual-editor/queries'
import { TicketWithTags } from '~/lib/visual-editor/types'

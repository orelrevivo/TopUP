...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from '~/components/visual-editor/ui/accordion'
import { Input } from '~/components/visual-editor/ui/input'
import { Label } from '~/components/visual-editor/ui/label'
import {
  AlignCenter,
...
import { Tabs, TabsTrigger, TabsList } from '~/components/visual-editor/ui/tabs'
import {
  Select,
  SelectContent,
  SelectGroup,
  ...
  SelectTrigger,
  SelectValue,
} from '~/components/visual-editor/ui/select'
import { useEditor } from '~/providers/visual-editor/editor/editor-provider'
import { Slider } from '~/components/visual-editor/ui/slider'
          ...
          {state.editor.selectedElement.type === 'contactForm' &&
            !Array.isArray(state.editor.selectedElement.content) && (
              <div className="flex flex-col gap-2">
                ...
                />
                <p className="text-muted-foreground mt-2">Form Subtitle</p>
                <Input
                  id="subTitle"

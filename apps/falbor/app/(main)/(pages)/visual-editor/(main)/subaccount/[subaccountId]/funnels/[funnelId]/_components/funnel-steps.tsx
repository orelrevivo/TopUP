'use client'
import CreateFunnelPage from '~/components/visual-editor/forms/funnel-page'
import CustomModal from '~/components/visual-editor/global/custom-modal'
import { AlertDialog } from '~/components/visual-editor/ui/alert-dialog'
import { Button } from '~/components/visual-editor/ui/button'
import { ScrollArea } from '~/components/visual-editor/ui/scroll-area'
import { toast } from '~/components/visual-editor/ui/use-toast'
import { upsertFunnelPage } from '~/lib/visual-editor/queries'
import { FunnelsForSubAccount } from '~/lib/visual-editor/types'
import { useModal } from '~/providers/visual-editor/modal-provider'
import { FunnelPage } from '~/lib/db/schema'
...
import FunnelPagePlaceholder from '~/components/visual-editor/icons/funnel-page-placeholder'
              ...
              <CardHeader>
                ...
                <CardDescription className="flex flex-col gap-4">
                  <div className="border-2 rounded-lg sm:w-80 w-full  overflow-clip">
                    <Link
                      href={`/visual-editor/subaccount/${subaccountId}/funnels/${funnelId}/editor/${clickedPage?.id}`}

          ...
          <div className="relative top-10">
            ...
            <div className="space-y-8 text-zinc-700 leading-relaxed px-4 md:px-8">
              ...
              <section>
                ...
                <p>
                  If you encounter any problems, need assistance, or have questions about these terms, please contact our support team at <a href="mailto:contact@falbor.xyz" className="text-blue-600 hover:underline">contact@falbor.xyz</a>.
                </p>
              </section>

...
export type ActionType = 'file' | 'shell' | 'supabase' | 'scan' | 'analyzer' | 'question';
...
export type FalborAction = FileAction | ShellAction | StartAction | BuildAction | SupabaseAction | ScanAction | AnalyzerAction | QuestionAction;

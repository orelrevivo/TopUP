      ...
      return (
        <div className="flex flex-col gap-4">
          ...
          <div className="max-h-[60vh] overflow-y-auto">
            {/* The form internally handles submission. We don't have an easy way to hook into success without modifying it, 
                so we rely on the user to go back after they see success in the form. */}
            <AgencyDetails data={{}} />
          </div>
    ...
    if (mode === 'manual_subaccount') {
      return (
        <div className="flex flex-col gap-4">
          ...
          {/* Again, wait for user to finish and then they can proceed */}

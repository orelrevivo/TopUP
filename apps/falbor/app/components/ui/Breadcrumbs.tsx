      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-falbor-elements-textPrimary dark:text-falbor-elements-textPrimary-dark'
              : 'text-falbor-elements-textSecondary dark:text-falbor-elements-textSecondary-dark hover:text-falbor-elements-textPrimary dark:hover:text-falbor-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-falbor-elements-textTertiary dark:text-falbor-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>

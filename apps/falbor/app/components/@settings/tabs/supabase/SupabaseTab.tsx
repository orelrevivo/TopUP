        ...
        <CollapsibleTrigger asChild>
          <div className="flex items-center justify-between p-4 rounded-lg bg-falbor-elements-background dark:bg-falbor-elements-background-depth-2 border border-falbor-elements-borderColor dark:border-falbor-elements-borderColor hover:border-falbor-elements-borderColorActive/70 dark:hover:border-falbor-elements-borderColorActive/70 transition-all duration-200 cursor-pointer">
            <div className="flex items-center gap-2">
              <div className="i-ph:database w-4 h-4 text-falbor-elements-item-contentAccent" />
        ...
        <CollapsibleContent className="overflow-hidden">
          <div className="space-y-4 mt-4">
              ...
              <div className="mb-6 p-4 bg-falbor-elements-background-depth-1 rounded-lg border border-falbor-elements-borderColor">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-falbor-elements-textSecondary">Total Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-falbor-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status === 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-falbor-elements-textSecondary">Active Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-falbor-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p: SupabaseProject) => p.region)).size}
                    </div>
                    <div className="text-xs text-falbor-elements-textSecondary">Regions Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-falbor-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status !== 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-falbor-elements-textSecondary">Inactive Projects</div>
                  </div>
                </div>
              </div>
            ) : null}
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project: SupabaseProject) => (
                  <div
                    key={project.id}
                    className={classNames(
                      'p-4 rounded-lg border transition-colors bg-falbor-elements-background-depth-1 cursor-pointer',
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-falbor-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:database w-4 h-4 text-falbor-elements-borderColorActive" />
                          {project.name}
                        </h5>
                        <div className="flex items-center gap-2 mt-2 text-xs text-falbor-elements-textSecondary">
                    ...
                    {selectedProjectId === project.id && (
                      <div className="space-y-4 mt-4 pt-4 border-t border-falbor-elements-borderColor">
                        <div className="flex flex-wrap items-center gap-1">
                          {projectActions.map((action) => (
                            <Button
                              ...
                              className="flex items-center gap-1 text-xs px-2 py-1 text-falbor-elements-textPrimary dark:text-falbor-elements-textPrimary"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="bg-falbor-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            ...
                            <div className="space-y-1 text-xs text-falbor-elements-textSecondary">
                        ...
                        {connection.credentials && (
                          <div className="bg-falbor-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-falbor-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:key w-4 h-4 text-falbor-elements-item-contentAccent" />
                              Project Credentials
                            </h6>
                            <div className="space-y-2">
                              <div>
                                <label className="text-xs text-falbor-elements-textSecondary">Supabase URL:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="text"
                                    value={connection.credentials.supabaseUrl || ''}
                                    readOnly
                                    className="flex-1 px-2 py-1 text-xs bg-falbor-elements-background border border-falbor-elements-borderColor rounded"
                                  />
                                  <Button
                                    size="icon"
                                    variant="outline"
                              ...
                              <div>
                                <label className="text-xs text-falbor-elements-textSecondary">Anon Key:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="password"
              ...
              <div className="text-sm text-falbor-elements-textSecondary flex items-center gap-2 p-4">
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            ...
            <div className="space-y-6">
              ...
              {connection.user && (
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-falbor-elements-background-depth-1 dark:bg-falbor-elements-background-depth-1 rounded-lg">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                      <div className="i-ph:user w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-falbor-elements-textPrimary">{connection.user.email}</h4>
                      <p className="text-sm text-falbor-elements-textSecondary">
                        {connection.user.role} • Member since{' '}
                        {new Date(connection.user.created_at).toLocaleDateString()}
                      </p>
                      <div className="flex items-center gap-4 mt-2 text-xs text-falbor-elements-textSecondary">
                        <span className="flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-falbor-elements-background-depth-2 p-3 rounded-lg border border-falbor-elements-borderColor">
                        <h6 className="text-xs font-medium text-falbor-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:chart-line w-4 h-4 text-falbor-elements-item-contentAccent" />
                          Database Health
                        </h6>
                      ...
                      <div className="bg-falbor-elements-background-depth-2 p-3 rounded-lg border border-falbor-elements-borderColor">
                        <h6 className="text-xs font-medium text-falbor-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:shield-check w-4 h-4 text-falbor-elements-item-contentAccent" />
                          Auth & Security
                        </h6>
                        <div className="space-y-1">
                          {(() => {
                      ...
                      <div className="bg-falbor-elements-background-depth-2 p-3 rounded-lg border border-falbor-elements-borderColor">
                        <h6 className="text-xs font-medium text-falbor-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:globe w-4 h-4 text-falbor-elements-item-contentAccent" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-3 bg-falbor-elements-background-depth-1 rounded-lg border border-falbor-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:database w-4 h-4 text-falbor-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-falbor-elements-textPrimary">Database</span>
                      </div>
                    ...
                    <div className="p-3 bg-falbor-elements-background-depth-1 rounded-lg border border-falbor-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:folder w-4 h-4 text-falbor-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-falbor-elements-textPrimary">Storage</span>
                      </div>
                      <div className="text-sm text-falbor-elements-textSecondary">
                        <div>
                          Buckets:{' '}
                    ...
                    <div className="p-3 bg-falbor-elements-background-depth-1 rounded-lg border border-falbor-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:code w-4 h-4 text-falbor-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-falbor-elements-textPrimary">Functions</span>
                      </div>
                      <div className="text-sm text-falbor-elements-textSecondary">
                        <div>
                          Deployed:{' '}

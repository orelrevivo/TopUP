...
export const Artifact = memo(({ artifactId, messageId, append }: ArtifactProps) => {
  ...
  return (
    <>
      <div className="artifact border border-falbor-elements-borderColor flex flex-col overflow-hidden rounded-lg w-full transition-border duration-150">
        <div className="flex">
          <button
            className="flex items-stretch bg-falbor-elements-artifacts-background hover:bg-falbor-elements-artifacts-backgroundHover w-full overflow-hidden"
            onClick={() => {
          ...
          >
            <div className="px-5 p-3.5 w-full text-left">
              ...
              <div className="w-full w-full text-falbor-elements-textSecondary text-xs mt-0.5">

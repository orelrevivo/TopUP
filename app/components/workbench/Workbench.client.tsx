          ...
          >
            ...
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="h-full flex flex-col bg-falbor-elements-background-depth-2 border border-falbor-elements-borderColor shadow-sm rounded-xl overflow-hidden">
                {selectedView !== 'research' && selectedView !== 'resources' && (
                  <div className="flex items-center px-3 py-2 border-b border-falbor-elements-borderColor gap-1.5 z-10 bg-falbor-elements-background-depth-2">
                    <button
                ...
                <div className="relative flex-1 overflow-hidden">
                  ...
                  <View
                    initial={{ x: '100%' }}
                    animate={{ x: selectedView === 'database' ? '0%' : (selectedView === 'research' || selectedView === 'resources' ? '-100%' : '100%') }}
                  >
                  ...
                  <View
                    initial={{ x: '100%' }}
                    animate={{ x: selectedView === 'resources' ? '0%' : '100%' }}
                  >
                    <ResourcesView />
                  </View>
                </div>

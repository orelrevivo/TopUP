  ...
  ({
    ...
    return (
      <div className="relative z-port-dropdown" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div className="absolute left-0 mt-2 bg-falbor-elements-background-depth-2 border border-falbor-elements-borderColor rounded shadow-sm min-w-[140px] dropdown-animation">
            <div className="px-4 py-2 border-b border-falbor-elements-borderColor text-sm font-semibold text-falbor-elements-textPrimary">
              Ports
            </div>
            {sortedPreviews.map((preview) => (
              <div
                key={preview.port}
                className="flex items-center px-4 py-2 cursor-pointer hover:bg-falbor-elements-item-backgroundActive"
                onClick={() => {
                ...
                <span
                  className={
                    activePreviewIndex === preview.index
                      ...
                      : 'text-falbor-elements-item-contentDefault group-hover:text-falbor-elements-item-contentActive'
                  }
                >
                  {preview.port}
                </span>

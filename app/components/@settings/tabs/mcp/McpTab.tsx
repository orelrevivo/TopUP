    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-falbor-elements-textPrimary">MCP Servers Configured</h2>{' '}
          <button
        ...
        <div className="space-y-4">
          ...
          <div className="mt-2 text-sm text-falbor-elements-textSecondary">
            ...
            <a
              ...
              className="text-falbor-elements-link hover:underline inline-flex items-center gap-1"
            >

...
const gitlabBranchesPOST = withSecurity(gitlabBranchesLoader);

export async function POST(request: Request) {
  return gitlabBranchesPOST({ request, context: { cloudflare: { env: process.env as Record<string, string> } } });
}

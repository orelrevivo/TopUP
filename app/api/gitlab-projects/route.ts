...
const gitlabProjectsPOST = withSecurity(gitlabProjectsLoader);

export async function POST(request: Request) {
  return gitlabProjectsPOST({ request, context: { cloudflare: { env: process.env as Record<string, string> } } });
}

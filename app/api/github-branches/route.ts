...
const githubBranchesHandler = withSecurity(githubBranchesLoader);

export async function GET(request: Request) {
  return githubBranchesHandler({ request, context: { cloudflare: { env: process.env as Record<string, string> } } });
}

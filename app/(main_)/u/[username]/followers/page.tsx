...
async function getFollowers(username: string) {
  ...
  // Then fetch their followers by joining follows and users tables
    ...
    <div className="w-full min-h-screen bg-[#F1EEEA] dark:bg-transparent antialiased font-sans py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mt-4 text-gray-900 dark:text-white">Followers</h1>
        </div>
        ...
        {followers.length === 0 ? (
          <div className="text-center py-12 bg-white dark:bg-[#1A1A1A] rounded-2xl border border-gray-200 dark:border-gray-800">
            ...
            <p className="text-gray-500 dark:text-gray-400">Nobody is following @{displayUsername} yet.</p>
          </div>
        ) : (

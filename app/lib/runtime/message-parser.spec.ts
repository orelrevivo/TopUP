...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out falbor artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <falbor', 'Foo bar '],
      ['Foo bar <falbora', 'Foo bar <falbora'],
      ['Foo bar <falborA', 'Foo bar '],
      ['Foo bar <falborArtifacs></falborArtifact>', 'Foo bar <falborArtifacs></falborArtifact>'],
      ['Before <oltArtfiact>foo</falborArtifact> After', 'Before <oltArtfiact>foo</falborArtifact> After'],
      ['Before <falborArtifactt>foo</falborArtifact> After', 'Before <falborArtifactt>foo</falborArtifact> After'],
    ])('should correctly parse chunks and strip out falbor artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <falborArtifact title="Some title" id="artifact_1">foo bar</falborArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <falborArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</falborArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</falborArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</falborArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <falborArtifact title="Some title" id="artifact_1">foo</falborArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <falborArtifact title="Some title" id="artifact_1"><falborAction type="shell">npm install</falborAction></falborArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <falborArtifact title="Some title" id="artifact_1"><falborAction type="shell">npm install</falborAction><falborAction type="file" filePath="index.js">some content</falborAction></falborArtifact> After',
        {
          output: 'Before  After',
